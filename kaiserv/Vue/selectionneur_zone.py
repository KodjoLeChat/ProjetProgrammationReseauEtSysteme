    ...
    def draw(self, test, test2):
        ...
        try:
            ...
            if isinstance(test, tuple):
                ...
                pos_start = test2
                count = 1
        self.image_to_draw = pygame.transform.scale(self.original_surface, (
        size_of_original_image[0] * self.carriere.zoom.multiplier,
        size_of_original_image[1] * self.carriere.zoom.multiplier))
        self.grid_to_draw = []
        ...
        for grid in self.grid_to_draw:
            if self.path != "assets/upscale_house/Housng1a_00045.png" or self.carriere.controleur.check_if_construction_possible_on_grid(
                    grid):
